...
1. In your own words, define closure (1-2 sentences).
  Closure gives us access to an outer function scope from an inner function.
...
a. Where is closure used in this code? How can you tell?
  Closure is used in defining the variable newRoll.  We can tell because it is inside the function.
b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?
  The name "Dan" will always be the same, but the number will change.
